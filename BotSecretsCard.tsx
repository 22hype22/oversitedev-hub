...
import { GuildChannelPicker } from "@/components/dashboard/GuildChannelPicker";
...
// Inlined so there's no separate file to create. Voice-channel picker for
// dispatch bots — writes the chosen channel to the DISPATCH_VOICE_CHANNEL_ID
// secret, which the bot reads live.
function DispatchVoiceCard({ bot }: { bot: OwnedBot }) {
    ...
    <Card className="rounded-2xl border border-os-hairline/50 bg-os-surface/40 p-5 shadow-lg shadow-black/10">
      <div className="flex items-center gap-3">
        <div className="h-10 w-10 rounded-xl border border-os-accent/30 bg-os-accent/10 grid place-items-center shrink-0">
          <Radio className="h-[18px] w-[18px] text-os-accent" />
        </div>
        <div>
          <div className="font-display font-semibold text-os-heading">Dispatch voice channel</div>
          <p className="text-xs text-os-faint mt-1 leading-relaxed">
      ...
      {saving ? (
        <div className="mt-3 flex items-center gap-1.5 text-xs text-os-faint">
