    ...
    extend: {
      ...
      keyframes: {
        ...
        "plane-fly": {
          ...
          "10%": { opacity: "1" },
          "25%": { transform: "translate(20vw,-25vh) rotate(10deg) scale(1)" },
          "50%": { transform: "translate(50vw,-10vh) rotate(-5deg) scale(1.1)" },
          "75%": { transform: "translate(20vw,15vh) rotate(20deg) scale(1)" },
          "90%": { opacity: "1" },
          "100%": { transform: "translate(45vw,-30vh) rotate(35deg) scale(0.3)", opacity: "0" },
        },
        "burst-in": {
