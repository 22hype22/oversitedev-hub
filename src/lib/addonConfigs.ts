  ...
  "anti-raid": {
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          { value: "lock", label: "Lock the server" },
          { value: "kick", label: "Kick raiders" },
          { value: "ban", label: "Ban raiders" },
          { value: "timeout", label: "Timeout raiders" },
          { value: "strip_roles", label: "Strip roles from raiders" },
          { value: "alert_only", label: "Alert staff only" },
        ],
      },
      ...
      multirole(
        "stripExemptRoles",
        "Roles to keep when stripping",
        "When the Strip roles action runs, these roles will NOT be removed from raiders.",
      ),
    ],
  },
