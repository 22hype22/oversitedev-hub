...
export const ADDON_CONFIGS: Record<string, AddonConfig> = {
  ...
  "customs-verification": {
    ...
    fields: [
      ...
      // The Verify button's label and colour are edited on the button itself,
      // in the panel design below, where it can also be moved.
      header("Remembering members"),
      toggle("reuse_verifications", "Recognise members verified elsewhere", true,
        "Someone who has already verified through any Oversite bot is verified here without logging in to Roblox again. Their link was proven by Roblox the first time."),
      toggle("auto_verify_on_join", "Verify known members when they join", true,
        "A recognised member gets their nickname and roles the moment they join, before they press anything. Needs the option above."),
      header("Roblox OAuth app (optional)"),
      {
        key: "roblox_client_id",
        label: "Roblox OAuth Client ID",
        type: "text",
        placeholder: "Leave blank to use Oversite's app",
        help: "Optional. Leave both fields blank and members verify through Oversite's Roblox app — they will see Oversite on the Roblox consent screen. To use your own, create one at create.roblox.com → Credentials and set its redirect URL to your bot's verify callback.",
      },
      {
        ...
        type: "text",
        placeholder: "Leave blank to use Oversite's app",
        help: "Only with your own app. Keep it private.",
      },
    ],
  },
