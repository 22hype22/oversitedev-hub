...
export const ADDON_CONFIGS: Record<string, AddonConfig> = {
  ...
  "customs-giveaway": {
    title: "Giveaway",
    summary: "Design how /giveaway looks — title, Enter button, host line, and defaults. Staff run /giveaway to launch one.",
    icon: Gift,
    fields: [
      {
        key: "title",
        ...
        help: "The heading on every giveaway post. Add an emoji by typing it in.",
      },
      {
        key: "button_label",
        ...
        defaultValue: "🎉 Enter",
        placeholder: "🎉 Enter",
        help: "Text on the button members click to enter. Include an emoji if you like.",
      },
      {
        key: "host_line",
        label: "Host / rules line",
        type: "textarea",
        markdown: true,
        placeholder: "Must be in the server to win • Hosted by the staff team",
        help: "Optional line shown under the prize on every giveaway. Leave blank for none.",
      },
      {
        key: "ping",
        label: "Ping with each giveaway",
        type: "text",
        placeholder: "@everyone or @Giveaways",
        help: "Optional — text/role posted above the giveaway so members get notified. Leave blank for no ping.",
      },
      header("Defaults for the /giveaway form"),
      {
        key: "default_winners",
        label: "Default winners",
        type: "number",
        defaultValue: 1,
        help: "Pre-filled winner count when staff open the /giveaway form.",
      },
      {
        ...
        defaultValue: "1d",
        placeholder: "1d",
        help: "Pre-filled length. Format: 10m, 2h, 1d, 1w, 1mo.",
      },
