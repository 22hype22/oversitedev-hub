...
export const ADDON_CONFIGS: Record<string, AddonConfig> = {
  ...
  "customs-tickets": {
    ...
    fields: [
      ...
      header("Ticket panel"),
      channel("panel_channel_id", "Panel channel", "Where the Open Ticket panel is posted. Design it below; it posts here on Save."),
      {
        key: "open_button_label",
        label: "Open button label",
        type: "text",
        defaultValue: "Open Ticket",
        placeholder: "Open Ticket",
        help: "Text on the Open Ticket button. Add an emoji by typing it in, e.g. 🎫 Open Ticket.",
      },
      {
        key: "open_button_style",
        label: "Open button color",
        type: "select",
