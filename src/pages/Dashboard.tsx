    ...
    <div className="oversite-theme min-h-screen bg-os-bg font-body text-os-body antialiased">
      ...
      <main className="mx-auto w-full max-w-[880px] px-5 pb-24 pt-28">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-x-7 gap-y-2 border-t border-os-hairline/15 pt-6">
          <Link to="/legal/privacy-policy" className="text-[12.5px] text-os-faint transition-colors hover:text-os-heading">Privacy Policy</Link>
          <Link to="/legal/terms-of-use" className="text-[12.5px] text-os-faint transition-colors hover:text-os-heading">Terms of Use</Link>
          <Link to="/legal/sales-and-refunds" className="text-[12.5px] text-os-faint transition-colors hover:text-os-heading">Sales &amp; Refunds</Link>
        </div>
