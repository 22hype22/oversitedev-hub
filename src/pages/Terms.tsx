...
const REFUNDS: Section[] = [
  ...
  { h: "Paying in Robux", body: [
    "Some products can be paid for in Robux. The Robux price is the dollar price plus 30 percent, converted at 100 Robux per dollar and rounded up to a figure ending in 999, and is shown before you choose Robux. To pay in Robux you sign in with Roblox on our site, tell us which kind of Roblox account you have, and buy the item we set up for your order from the Oversite Customs group: a game pass for standard accounts, or a shirt from the group store for accounts Roblox designates for younger users. Your order is confirmed, and your bot’s build begins, only once the sale appears in the group’s records from your linked Roblox account. A purchase must be confirmed within five minutes of buying; if Roblox is slow to record a sale, wait a moment and try again, or open a ticket in our Discord and we will match it by hand.",
