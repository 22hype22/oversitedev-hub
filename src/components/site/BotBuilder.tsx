...
const ADDONS_BY_BASE: Record<string, Addon[]> = {
  protection: [
    { id: "advanced-logging", name: "Advanced Logging", desc: "Message edits, deletes, and full event logs.", icon: FileText, price: 4.99 },
    { id: "nsfw-invite-scanner", name: "NSFW Invite Scanner", desc: "Detects NSFW invites with censored logs. ✅ Already built.", icon: ShieldCheck, price: 5.99 },
    { id: "avatar-nsfw-detection", name: "Avatar NSFW Detection", desc: "Flags inappropriate user avatars automatically. ✅ Already built.", icon: EyeOff, price: 5.99 },
    { id: "bio-phrase-detection", name: "Bio Phrase Detection", desc: "Catches banned phrases in member bios. ✅ Already built.", icon: TextCursorInput, price: 4.99 },
    { id: "admin-abuse-detection", name: "Admin Abuse Detection", desc: "Spots staff members abusing their permissions. ✅ Already built.", icon: AlertTriangle, price: 6.99 },
    { id: "new-account-age-gate", name: "New Account Age Gate", desc: "Restrict brand-new Discord accounts. ✅ Already built.", icon: UserPlus, price: 3.99 },
    { id: "auto-escalating-warns", name: "Auto-Escalating Warnings", desc: "3 warns = mute, 5 = ban, fully tunable. ✅ Already built.", icon: AlertTriangle, price: 4.99 },
    { id: "softban-massban", name: "/softban & /massban", desc: "Quickly purge or ban groups of users.", icon: Ban, price: 3.99 },
    { id: "channel-lockdown", name: "Channel Lockdown Command", desc: "Instantly lock channels in an emergency.", icon: Lock, price: 2.99 },
    { id: "unban-command", name: "/unban Command", desc: "Reverse bans cleanly with one command.", icon: UserCheck, price: 1.99 },
    { id: "staff-notes", name: "Staff Notes on Users", desc: "Private staff-only notes attached to members.", icon: ClipboardList, price: 2.99 },
    { id: "modlog", name: "User Moderation History (/modlog)", desc: "Full punishment history per user.", icon: FileText, price: 3.99 },
    { id: "slowmode-auto", name: "Auto-Slowmode on Spam", desc: "Triggers slowmode automatically when spam is detected.", icon: Timer, price: 2.99 },
    { id: "temp-bans", name: "Temporary Bans", desc: "Bans with auto-unban timers.", icon: Ban, price: 3.99 },
  ],
  support: [
    { id: "unlimited-categories", name: "Unlimited Ticket Categories", desc: "Add as many ticket categories as you want. ✅ Already built.", icon: Ticket, price: 2.99 },
    { id: "ticket-transcripts", name: "Ticket Transcripts", desc: "Auto-generated transcripts of every ticket. ✅ Already built.", icon: FileText, price: 3.99 },
    { id: "per-category-roles", name: "Per-Category Role Access", desc: "Assign which roles can see each category. ✅ Already built.", icon: ShieldCheck, price: 2.99 },
    { id: "ticket-notes", name: "Ticket Notes", desc: "Internal staff notes inside each ticket. ✅ Already built.", icon: ClipboardList, price: 1.99 },
    { id: "ticketadd-remove", name: "/ticketadd & /ticketremove", desc: "Add or remove members from a ticket. ✅ Already built.", icon: UserPlus, price: 1.99 },
    { id: "suggestion-approve-deny", name: "Suggestion System (Approve/Deny)", desc: "Collect, approve, or deny community suggestions. ✅ Already built.", icon: Lightbulb, price: 2.99 },
    { id: "ticket-claim", name: "Ticket Claim System", desc: "Staff can claim tickets they're handling. ✅ Already built.", icon: Hand, price: 1.99 },
    { id: "closeall", name: "/closeall Command", desc: "Close every open ticket at once. ✅ Already built.", icon: Trash2, price: 1.99 },
    { id: "ticket-customization", name: "Ticket Message Customization", desc: "Fully customize every ticket message. ✅ Already built.", icon: Settings2, price: 2.99 },
    { id: "priority-flagging", name: "Priority Ticket Flagging", desc: "Mark tickets as high priority for staff.", icon: Flag, price: 2.99 },
    { id: "ticket-stats", name: "Ticket Stats Dashboard", desc: "See volume, response time, and trends.", icon: BarChart2, price: 4.99 },
    { id: "auto-close-inactive", name: "Auto-Close Inactive Tickets", desc: "Close tickets after X days of inactivity.", icon: Clock, price: 2.99 },
    { id: "anonymous-reporting", name: "Anonymous Reporting", desc: "Members can report rule-breakers anonymously.", icon: Flag, price: 3.99 },
    { id: "staff-performance", name: "Staff Performance Tracking", desc: "Track who's closing the most tickets.", icon: BarChart3, price: 4.99 },
  ],
  utilities: [
    { id: "spotify-music", name: "Spotify Music Integration", desc: "Stream Spotify directly in voice channels. ✅ Already built.", icon: Music, price: 5.99 },
    { id: "auto-radio", name: "Auto-Radio by Genre", desc: "Endless music from the genres you choose. ✅ Already built.", icon: Music, price: 4.99 },
    { id: "roblox-verification", name: "Roblox Verification + Role Sync", desc: "Verify Roblox accounts and sync roles. ✅ Already built.", icon: UserCheck, price: 5.99 },
    { id: "starboard", name: "Starboard", desc: "Highlight the best messages in a starboard channel. ✅ Already built.", icon: Star, price: 1.99 },
    { id: "custom-commands", name: "Custom Commands", desc: "Create your own slash commands. ✅ Already built.", icon: Code2, price: 3.99 },
    { id: "recurring-messages", name: "Recurring Messages", desc: "Auto-post messages on a schedule. ✅ Already built.", icon: Calendar, price: 2.99 },
    { id: "reaction-roles-unlimited", name: "Unlimited Reaction Roles", desc: "Add as many reaction roles as you want. ✅ Already built.", icon: Smile, price: 2.99 },
    { id: "sticky-messages", name: "Sticky / Repeating Messages", desc: "Pin a message to the bottom of a channel. ✅ Already built.", icon: MessageSquare, price: 2.99 },
    { id: "review-system", name: "Review System", desc: "Collect and display member reviews. ✅ Already built.", icon: Star, price: 2.99 },
    { id: "purge-bulk-delete", name: "/purge Bulk Delete", desc: "Bulk-delete messages with filters.", icon: Trash2, price: 1.99 },
    { id: "giveaway-system", name: "Giveaway System", desc: "Run timed giveaways with auto-winner picking.", icon: Gift, price: 3.99 },
    { id: "birthday-announcements", name: "Birthday Announcements", desc: "Celebrate member birthdays automatically.", icon: Cake, price: 1.99 },
    { id: "stats-channels", name: "Server Stats Channels", desc: "Auto-updating member count channel names.", icon: BarChart3, price: 2.99 },
    { id: "live-notifications", name: "Twitch / YouTube Live Notifications", desc: "Notify your server when streamers go live.", icon: Bell, price: 3.99 },
    { id: "leveling-system", name: "Leveling System", desc: "XP, levels, and role rewards for activity.", icon: Zap, price: 4.99 },
    { id: "economy-system", name: "Economy System", desc: "Currency, shop, and rewards for your server.", icon: Database, price: 5.99 },
    { id: "remindme", name: "/remindme Personal Reminders", desc: "Personal reminders for any user. ✅ Already built.", icon: AlarmClock, price: 1.99 },
  ],
  scratch: [],
