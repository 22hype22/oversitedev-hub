      ...
      <Container>
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-3 lg:grid-cols-6">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5">
              <li><FooterLink to="/legal/privacy-policy" label="Privacy Policy" /></li>
              <li><FooterLink to="/legal/terms-of-use" label="Terms of Use" /></li>
              <li><FooterLink to="/legal/sales-and-refunds" label="Sales and Refunds" /></li>
            </ul>
          </div>
        </div>
