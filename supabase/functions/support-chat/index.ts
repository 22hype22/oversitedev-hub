...
Age: 13 or Discord's minimum in your region. Under the age of majority needs a parent's consent. Accounts cannot be shared, sold or transferred. Using a bot to break the law, Discord's rules or Roblox's rules, or to interfere with the service, can get it suspended. Data is kept while the account is active and deleted or anonymized within a reasonable period on request. Data is hosted in Minnesota. A bot's data is deleted when the bot is deleted, and bot data is otherwise kept for a month. Account deletion requests take 24 to 48 hours. Do not discuss security certifications or audits. Governing law is Minnesota with individual arbitration; you can opt out of arbitration by email within 30 days of accepting the terms. Full text at oversite.shop/legal/privacy-policy, oversite.shop/legal/terms-of-use and oversite.shop/legal/sales-and-refunds.
