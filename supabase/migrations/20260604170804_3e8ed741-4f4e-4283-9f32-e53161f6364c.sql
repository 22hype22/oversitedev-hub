...
REVOKE ALL ON FUNCTION public.runtime_award_user_xp(text, uuid, text, text, integer) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.runtime_award_user_xp(text, uuid, text, text, integer) TO service_role;