...
BEGIN
  ...
  END IF;
  SELECT email INTO _prev_owner_email FROM auth.users WHERE id = _row.owner_user_id;
  ...
  RETURN jsonb_build_object(
    ...
    'previous_owner_email', _prev_owner_email,
    'new_owner_email', _caller_email,
    'transfer_id', _row.id,
    'needs_billing', true
  );
END;
